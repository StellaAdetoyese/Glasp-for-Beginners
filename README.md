...
### What is Glasp?
[Glasp](https://glasp.co/) short for "Greatest Legacy Accumulated as Shared Proof" a tool thast allows users to highlight and annotate text on web pages.  Glasp was co-founded by Kazuki . The web-based tool aims to create a platform where people can share information and learn from the experiences of others. The app was developed based on the idea that if everyone's brains were shared in a common repository like Dropbox, valuable information could be applied to activities that people believed in. Glasp is focused on leaving a legacy for future generations by making knowledge accessible and shareable.
